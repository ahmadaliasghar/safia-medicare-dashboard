    ...
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          <AnalyticsCard
            heading="Patients"
            style="bg-[#F4F7FDff] text-[#2961E2ff]"
            color=""
            value={150}
            icon={<FaUsersLine size={34} />}
          />
          <AnalyticsCard
            heading="Total Staff"
            style="bg-[#F2F9FFff] text-[#0496FFff]"
            color="#0496FFff"
            value={10}
            icon={<FaUserDoctor size={34} />}
          />
          <AnalyticsCard
            heading="Patients being treated"
            style="bg-[#FFF7F2ff] text-[#FF9345ff]"
            color="#FF9345ff"
            value={55}
            icon={<LuBed size={34} />}
          />
          <AnalyticsCard
            heading="Avg. Cost"
            value={350}
            style="bg-[#F9F9F9ff] text-[#273245ff]"
            color="#273245ff"
            icon={<LuCircleDollarSign size={34} />}
          />
        </div>
